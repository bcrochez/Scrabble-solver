...
def initInterface():
    rectanglePlein(0, 0, 1200, 700, "dark orange")
...
def afficheScoreTot(score):
    rectanglePlein(10, 620, 300, 650+hauteurTexte("A"), "dark orange")
...
def afficheTirage(tirage):
    rectanglePlein(620, 20, 700+42, 20+15*42, "dark orange") # on masque les tirages précédents
...
def afficheCoup(mot, score):
    rectanglePlein(50, 150, 799, 190+42, "dark orange") # on masque les coups précédents
...
def affichePlateau(plateau, plateauBonus):
    ...
    rectanglePlein(2, 2, 602, 602, "dark orange")
    i = 0
    j = 0
    while i < 15:
        while j < 15:
